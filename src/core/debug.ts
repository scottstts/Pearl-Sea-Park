 ...
 *   ?pass=<name>    — isolate a render pass (ao, ao-filtered/applied/mask/footprint, bloom, caustics, rays, haze, depth, normal, water-fresnel/reflection/transmission/interface/validity/foam, no-post) or a wake diagnostic (wake-layers/age/flow)
